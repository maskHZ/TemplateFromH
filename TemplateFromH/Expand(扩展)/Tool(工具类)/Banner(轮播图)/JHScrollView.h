...
/** 点击图片回调 */
- (void)cycleScrollView:(JHScrollView *)cycleScrollView didSelectItemAtIndex:(NSInteger)index;
@end

@interface JHScrollView : UIView
...
//代理方法
@property (nonatomic,weak) id<JHScrollViewDelegate> delegate;

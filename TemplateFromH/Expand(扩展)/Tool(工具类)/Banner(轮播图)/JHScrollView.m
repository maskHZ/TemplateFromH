...
@interface JHScrollView()<UICollectionViewDataSource,UICollectionViewDelegate>
@property (nonatomic,strong) UIImageView *backgroundImageView;
@property (nonatomic,strong) JHScrollViewFlowLayou *flowLayout;
...
@end
static NSString *const cellID = @"JHCollectionCell";
...
{
    JHScrollView *cycleScrollView = [[JHScrollView alloc]initWithFrame:frame];
...
-(UICollectionView *)collectionView
{
    if(_collectionView == nil)
    {
        ...
        //注册cell
        [_collectionView registerClass:[JHCollectionViewCell class] forCellWithReuseIdentifier:cellID];
...
-(JHScrollViewFlowLayou *)flowLayout
{
    if(_flowLayout == nil)
    {
        _flowLayout = [[JHScrollViewFlowLayou alloc]init];

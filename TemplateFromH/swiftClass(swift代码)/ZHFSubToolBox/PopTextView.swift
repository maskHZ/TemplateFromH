...
class PopTextView: PopSmallChangeBigFatherView {
    @objc let titleHeight: CGFloat = 75
    @objc var placeHoldLable: UILabel = UILabel()
    @objc var textView:UITextView = UITextView()
    @objc var textStr : String = "请输入内容"
    @objc var oneBtn:UIButton = UIButton()
    @objc var otherBtn:UIButton = UIButton()
    @objc override func addAnimate() {
